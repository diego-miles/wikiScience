...
export function GridBackgroundDemo() {
  return (
    <div className="h-full w-full dark:bg-background1dark  bg-background1  dark:bg-grid-white/[0.02] bg-grid-black/[0.04] absolute flex items-center justify-center">
