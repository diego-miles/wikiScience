...
export function GridBackgroundDemo() {
  return (
    <div className="-z-10 h-full w-full dark:bg-background1dark  bg-background1  dark:bg-grid-transparent bg-grid-[#eaeef4] absolute flex items-center justify-center">
