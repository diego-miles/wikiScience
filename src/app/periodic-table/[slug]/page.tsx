  ...
  return (
    <>
      ...
      <main style={{ marginTop: '9rem' }} className='lg:pt-60'>
        ...
        <p className=' '><strong>Atomic Weight:</strong> {element.atomicWeight}</p>
        <p className=' '><strong>Appearance:</strong> {element.appearance}</p>
        ...
        <div className='lg:grid lg:grid-cols-2 gap-x-24 gap-y-12 lg:px-12 '>
          ...
          <section id="1-atomic-structure">
            {/* Atomic Structure */}
<div>
            <ContextHoverCard buttonText={"Atomic Structure"} questionMarkColor="#008eaa">
                    <Button  variant="link" className=''>
              <h2 className=' mt-0 pt-0 '>1. Atomic Structure</h2>
                      </Button>
            </ContextHoverCard>
</div>

<div className='flex text-left'>
              <ContextHoverCard buttonText={"Electrons"}  >
                    <Button  variant="link" className=' '>
              <strong className='  text-base'>Electrons:</strong>
                      </Button>
            </ContextHoverCard> 
            <p  >
...
<div className='flex'>
              <ContextHoverCard buttonText={"Protons"}  >
                    <Button  variant="link" className=' '>
              <strong className=''>Protons:</strong>
                      </Button>
            </ContextHoverCard>
            <p>
...
<div className='flex'>
              <ContextHoverCard buttonText={"Neutrons"}  >
                    <Button  variant="link" className=' '>
              <strong className=''>Neutrons:</strong>
                      </Button>
            </ContextHoverCard>
            <p>
...
<div className='flex'>
              <ContextHoverCard buttonText={"Ionization Energy"}  >
...
<div className='flex'>
              <ContextHoverCard buttonText={"Electron Affinity"} >
...
<div className='flex'>
              ...
              <ContextHoverCard buttonText={"Atomic Radius"} >
...
<div className='inline'>
  <div className=' '>
    <ContextHoverCard  buttonText={"Atomic Polarization"}>
      <strong className=' '>Atomic Polarization:</strong>
    </ContextHoverCard>
  </div>
  <p className=''>
...
<div className='flex'>
            ...
            <ContextHoverCard buttonText={"Electronegativity"} questionMarkColor="#358190">
            ...
            <ContextHoverCard buttonText={"First Ionization Potential"}>
              <strong>First Ionization Potential:</strong>
            </ContextHoverCard>
            <p className='flex'>
