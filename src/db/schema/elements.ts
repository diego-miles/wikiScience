...
export const citations = sqliteTable('citations', {
  ...
  yearOfAppearance: text('yearOfAppearance').primaryKey(),
  yearOfAppearanceAnnotations: text('yearOfAppearanceAnnotations').primaryKey(),
  inventorDiscoverer: text('inventorDiscoverer').primaryKey(),
  evolutionOfConceptContext: text('evolutionOfConceptContext').primaryKey(),
  ...
  visualizationAndAnimation: text('visualizationAndAnimation', { mode: 'json' }),
